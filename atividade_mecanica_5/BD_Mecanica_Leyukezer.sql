...
#FAÇA AQUI OS EXERCÍCIOS DE FIXAÇÃO I
...
Funcionario.datanasc_func as Data_Nascimento,
Funcionario.salário_func as Salario,
Funcionario.telefone_func as Telefone,
Funcionario.celular_func as Celular,
Funcionario.função_func as Funcao,
Sexo.nome_sex as Sexo,
Departamento.nome_dep as Departamento,
concat(Endereco.rua_end,', ', Endereco.numero_end,', ',Endereco.bairro_end,', ',Cidade.nome_cid,'/',Estado.sigla_Est) as Endereco
from
Funcionario inner join Sexo on (Funcionario.cod_sex_fk = Sexo.cod_sex)
...
Cliente.estadocivil_cli as Estado_civil,
Cliente.cpf_cli as Cpf,
Cliente.rg_cli as Rg,
Cliente.datanasc_cli as Data_nascimento,
Cliente.rendafamiliar_cli as Renda,
Cliente.telefone_cli as Telefone,
Cliente.celular_cli as Celular,
Sexo.nome_sex as Sexo,
concat(Endereco.rua_end,', ', Endereco.numero_end,', ',Endereco.bairro_end,', ',Cidade.nome_cid,'/',Estado.sigla_Est) as Endereco
From
Cliente inner join Sexo on (Cliente.cod_sex_fk = Sexo.cod_sex)
...
Venda.valortotal_vend as Valor_Total,
Venda.desconto_vend as Desconto,
Venda.formpag_vend as Forma_Pagamento,
Venda.quant_parcelas_vend as Parcela,
Funcionario.nome_func as Funcionario,
Cliente.nome_cli as Cliente
from
Venda inner join Funcionario on (Venda.cod_func_fk = Funcionario.cod_func)
...
Compra.valortotal_comp as Total,
Compra.formpag_comp as Forma_Pagamento,
Funcionario.nome_func as Funcionario,
Fornecedor.nomefantasial_forn as Fornecedor
from
Compra inner join Funcionario on (Compra.cod_func_fk = Funcionario.cod_func)
inner join Fornecedor on (Compra.cod_forn_fk = Fornecedor.cod_forn);

#FAÇA AQUI OS EXERCÍCIOS DE FIXAÇÃO II

select
Produto.descrição_prod as Descricao,
Produto.marca_prod as Marca,
Produto.quant_prod as Quantidade,
Fornecedor.nomefantasial_forn as Fornecedor
from
Produto left join Fornecedor on (Produto.cod_forn_fk = Fornecedor.cod_forn)